...
*This demo runs against `microsoft/azure-devops-mcp` — the orchestrator analyzing itself.*
*Compare results with the self-analysis to see how the workflow adapts to a very different project.*
...
```
Retrieve metadata for the GitHub repository owned by microsoft named azure-devops-mcp.
